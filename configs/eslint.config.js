...
export default ts.config(
  ...
  {
    files: ['src/mcp-server/verify-server.ts', 'src/mcp-server/code-generation-server.ts'],
    languageOptions: {
      parserOptions: {
        project: ['./configs/tsconfig/tsconfig.verify.json'],
        tsconfigRootDir: repoRoot,
  ...
  // T1 escalation (file-specific): track no-explicit-any in cleaned files
  {
    files: ['src/mcp-server/test-generation-server.ts', 'src/mcp-server/spec-synthesis-server.ts'],
    languageOptions: {
      parserOptions: {
        project: ['./configs/tsconfig/tsconfig.verify.json'],
        tsconfigRootDir: repoRoot,
