...
import type {
  ...
  AggregateModelingResult,
  BoundedContextDefinitionResult,
  BusinessRuleExtractionResult,
  UbiquitousLanguageResult,
  DomainServiceDesignResult,
  DomainModelValidationResult,
  GenericDomainAnalysisResult,
  ProactiveGuidanceContext,
  ProactiveGuidanceResult,
} from './domain-modeling-task-adapter.types.js';

export * from './domain-modeling-task-adapter.types.js';
