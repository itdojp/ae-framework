...
export class InventoryServiceImpl implements InventoryService {
  ...
  async createReservation(reservation: Reservation): Promise<ReservationEntity> {
    ...
    // TODO(#2226): Implement idempotency check for orderId
    // TODO(#2226): Create reservation in database with transaction
    // TODO(#2226): Update item reserved count
  ...
  async getItem(_itemId: string): Promise<Item | null> {
    // TODO(#2226): Implement database query
    return null;
  }
}
