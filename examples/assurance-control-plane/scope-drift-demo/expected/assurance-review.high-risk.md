# Scope Drift Assurance Demo Review — High-Risk Strict Lane
...
| policy-gate-summary | artifacts/policy/scope-drift-demo/policy-gate-summary.high-risk.json | present |
...
| --- | --- | --- | --- | --- | --- | --- |
| artifacts/policy/scope-drift-demo/policy-gate-summary.high-risk.json | risk:high | strict | block | false | 3 | 2 |

## Reviewer action list

- Start with this Markdown before raw logs; then open `artifacts/assurance/scope-drift-demo/assurance-summary.json` and `artifacts/policy/scope-drift-demo/policy-gate-summary.high-risk.json`.
