...
ae intent --analyze --sources "requirements.md"
 ...
 ae traceability matrix --map docs/specs/issue-traceability-map.json --tests "tests/**/*" --code "src/**/*" --context-pack "spec/context-pack/**/*.{yml,yaml,json}" --discovery-pack "spec/discovery-pack/**/*.{yml,yaml,json}" --format md --output docs/specs/ISSUE-TRACEABILITY-MATRIX.md
 ae tests:scaffold --input docs/templates/plan-to-spec-normalization-sample.md
