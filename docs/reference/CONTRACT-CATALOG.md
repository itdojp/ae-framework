...
| `spec/discovery-pack/**/*.{yml,yaml,json}` | `schema/discovery-pack-v1.schema.json` | manual authoring in `spec/discovery-pack/` | `scripts/discovery-pack/validate.mjs`, `src/cli/discovery-cli.ts` |
