...
| `artifacts/ci/policy-shadow-compare-v1.json` | 専用 schema 未整備（`contractId=policy-shadow-compare.v1`） | `scripts/ci/policy-shadow-compare.mjs`, `.github/workflows/policy-gate.yml` | `scripts/ci/validate-json.mjs`, `docs/ci/pr-automation.md`, `docs/ci/label-gating.md` |
