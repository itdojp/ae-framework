...
- spec-validation.yml: pull_request (paths: spec/**, .ae/**, artifacts/**, schema/**, specs/formal/**, .github/workflows/spec-validation.yml, .github/workflows/validate-artifacts-ajv.yml) + push (main, develop; same paths) + workflow_call
