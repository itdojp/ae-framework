...
| Controlled comparison | `docs/product/CONTROLLED-COMPARISON-PROTOCOL.md` is `protocol-ready, not executed` |
...
- Record reviewer disposition as `merge`, `request changes`, `defer`, `block`,
  or `not_collected`.
- Use `docs/product/CONTROLLED-COMPARISON-PROTOCOL.md` before turning pilot
  observations into review-speed, decision-quality, or benchmark claims.
...
| Controlled comparison | `docs/product/CONTROLLED-COMPARISON-PROTOCOL.md` は `protocol-ready, not executed` |
...
- pilot observation を review-speed、decision-quality、benchmark claim に変える前に
  `docs/product/CONTROLLED-COMPARISON-PROTOCOL.md` を使う。
