...
- [EVIDENCE-SPRINT-RELEASE-ASSETS-2026-07-01.md](./product/EVIDENCE-SPRINT-RELEASE-ASSETS-2026-07-01.md) - Evidence Sprint の release note、article outline、announcement copy、claim checklist
...
- [LIVE-PILOT-ENTRY-CRITERIA.md](./product/LIVE-PILOT-ENTRY-CRITERIA.md) - fixture-backed evidence を live external claim に昇格する前の entry criteria
...
初見の product evidence 導線は [FIRST-RUN-DEMO.md](./getting-started/FIRST-RUN-DEMO.md) → [byo-agent-assurance-quickstart.md](./guides/byo-agent-assurance-quickstart.md) → [Evidence Sprint dogfood case study](./product/EVIDENCE-SPRINT-DOGFOOD-CASE-STUDY-2026-07-01.md) → [fixture-backed Web API pilot](./product/EVIDENCE-SPRINT-WEB-API-PILOT-2026-07-01.md) → [fixture-backed event-driven pilot](./product/EVIDENCE-SPRINT-EVENT-DRIVEN-PILOT-2026-07-01.md) → [PILOT-REPORT-2026Q3-01.md](./product/PILOT-REPORT-2026Q3-01.md) → [LAUNCH-KIT.md](./product/LAUNCH-KIT.md) の limitations → [LIVE-PILOT-ENTRY-CRITERIA.md](./product/LIVE-PILOT-ENTRY-CRITERIA.md) → [CONTROLLED-COMPARISON-PROTOCOL.md](./product/CONTROLLED-COMPARISON-PROTOCOL.md) です。Web API / event-driven pilots は fixture-backed/report-only、現在の pilot report は `dry-run only` で、live external claim には entry criteria が必要、controlled comparison は未実施です。
...
- Assurance control plane E2E example: [examples/assurance-control-plane-e2e.md](./examples/assurance-control-plane-e2e.md)
...
- **🆕 [DELIVERY-CONTRACT-COMPATIBILITY-MATRIX.md](./architecture/DELIVERY-CONTRACT-COMPATIBILITY-MATRIX.md)** ⭐ **NEW** - delivery-layer 契約追加時の SSOT / split 方針
