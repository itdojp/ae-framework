...
- GitHub API の 429 / secondary rate limit が出る場合、Actions の rerun を優先します。必要に応じて `AE_GH_RETRY_*` を調整します（詳細: `docs/ci/pr-automation.md` / 実装: `scripts/ci/lib/gh-exec.mjs`）。
