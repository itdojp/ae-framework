...
| PR automation | `docs/ci/pr-automation.md` | `docs/ci/copilot-review-gate.md`, `docs/ci/copilot-auto-fix.md`, `docs/ci/auto-merge.md`, `docs/ci/change-package.md`, `docs/ci/agent-pr-assurance-metrics.md` | Copilot review gate, auto-fix, auto-merge, Change Package, PR warning category semantics, report-only agent PR metrics |
...
| PR自動化 | `docs/ci/pr-automation.md` | `docs/ci/copilot-review-gate.md`, `docs/ci/copilot-auto-fix.md`, `docs/ci/auto-merge.md`, `docs/ci/change-package.md`, `docs/ci/agent-pr-assurance-metrics.md` | Copilot review gate / auto-fix / auto-merge / Change Package / PR warning category semantics / report-only agent PR metrics |
