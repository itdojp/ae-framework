...
- `docs/README.md` から辿れる `docs/ci/*` / `docs/quality/*` の主要ドキュメントに加え、`docs/architecture/*` / `docs/contributing/*` / `docs/development/*` / `docs/flows/*` / `docs/getting-started/*` / `docs/guides/*` / `docs/integrations/*` / `docs/maintenance/*` / `docs/observability/*` / `docs/operate/*` / `docs/operations/*` / `docs/phases/*` / `docs/product/*` / `docs/project/*` / `docs/reference/*` / `docs/samples/*` / `docs/spec/*` / `docs/strategy/*` / `docs/testing/*` / `docs/trace/*` / `docs/troubleshooting/*` / `docs/verify/*` / `docs/workflows/*` の trust-tier front matter も既定スコープで検証する。
