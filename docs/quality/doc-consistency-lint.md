...
- `docs/README.md` から辿れる `docs/ci/*` / `docs/quality/*` の主要ドキュメントに加え、`docs/development/*` / `docs/flows/*` / `docs/getting-started/*` / `docs/guides/*` / `docs/integrations/*` / `docs/maintenance/*` / `docs/operate/*` / `docs/product/*` / `docs/project/*` / `docs/reference/*` / `docs/strategy/*` / `docs/trace/*` / `docs/verify/*` / `docs/workflows/*` の trust-tier front matter も既定スコープで検証する。
