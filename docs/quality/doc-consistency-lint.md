...
- `docs/README.md` から辿れる `docs/ci/*` / `docs/quality/*` の主要ドキュメントに加え、`docs/getting-started/*` / `docs/operate/*` / `docs/product/*` / `docs/project/*` の trust-tier front matter も既定スコープで検証する。
