...
| `artifacts/assurance/assurance-summary.json` | `pnpm run verify:assurance` を実行した場合 | assurance lane coverage / independence warning の集約結果（schema: `schema/assurance-summary.schema.json`） |
