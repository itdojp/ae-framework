...
- `artifacts/codex/**` is treated as a local debug archive ignored by default. If the repository needs to keep it as a tracked archive, it must be promoted under `artifacts/archive/**`.
