...
- Formal: `artifacts/summary/combined.json.formal` を優先し、fallback として `artifacts/hermetic-reports/formal/summary.json` / `artifacts/formal/formal-aggregate.json` / legacy `formal/summary.json` を表示
...
- Formal: fail — see `artifacts/hermetic-reports/formal/summary.json`
...
- Read from normalized JSON artifacts:
  ...
  - `artifacts/hermetic-reports/formal/summary.json` or legacy `formal/summary.json` (optional fallback)
...
- `artifacts/hermetic-reports/formal/summary.json` または legacy `formal/summary.json`（存在する場合）
...
- 例: `artifacts/hermetic-reports/formal/summary.json` / `artifacts/summary/combined.json`

#### リンク例（Short）
```
Formal: pass — artifacts/hermetic-reports/formal/summary.json
