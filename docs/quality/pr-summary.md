...
- `artifacts/summary/combined.json`
  - Primary normalized sidecar for `adapters`, `formal`, `properties`, `propertyDesign`, `bdd`, and `ltlSuggestions`.
...
### Summary Sections
- Coverage: overall percentage, threshold, delta
...
- Aggregate only validated artifacts.
