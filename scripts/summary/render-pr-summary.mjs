...
const claimEvidenceSecurityLine = claimEvidenceSecurity
  ? t(
      `Security findings: total=${claimEvidenceSecurity.findings ?? 'n/a'}, needs-human-review=${claimEvidenceSecurity.needsHumanReview ?? 'n/a'}, high/critical-open=${claimEvidenceSecurity.highOrCriticalOpen ?? 'n/a'}, out-of-scope=${claimEvidenceSecurity.outOfScope ?? 'n/a'}, rejected=${claimEvidenceSecurity.rejected ?? 'n/a'}, assumption-validation-required=${claimEvidenceSecurity.assumptionValidationRequired ?? 0}, assumption-residual-risk=${claimEvidenceSecurity.assumptionResidualRisk ?? 0}`,
      `security finding: total=${claimEvidenceSecurity.findings ?? 'n/a'}, human review=${claimEvidenceSecurity.needsHumanReview ?? 'n/a'}, high/critical-open=${claimEvidenceSecurity.highOrCriticalOpen ?? 'n/a'}, out-of-scope=${claimEvidenceSecurity.outOfScope ?? 'n/a'}, rejected=${claimEvidenceSecurity.rejected ?? 'n/a'}, assumption-validation-required=${claimEvidenceSecurity.assumptionValidationRequired ?? 0}, assumption-residual-risk=${claimEvidenceSecurity.assumptionResidualRisk ?? 0}`,
    )
  : '';
