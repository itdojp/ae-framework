...
const GOVERNED_PREFIX_DIRS = ['docs/agents', 'docs/ci', 'docs/development', 'docs/flows', 'docs/getting-started', 'docs/guides', 'docs/integrations', 'docs/maintenance', 'docs/operate', 'docs/product', 'docs/project', 'docs/quality', 'docs/reference', 'docs/strategy', 'docs/trace', 'docs/verify', 'docs/workflows'];
