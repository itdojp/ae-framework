...
const GOVERNED_PREFIX_DIRS = ['docs/agents', 'docs/development', 'docs/flows', 'docs/getting-started', 'docs/guides', 'docs/integrations', 'docs/operate', 'docs/product', 'docs/project', 'docs/quality', 'docs/reference', 'docs/strategy', 'docs/workflows'];
