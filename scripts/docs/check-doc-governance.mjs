...
const GOVERNED_PREFIX_DIRS = ['docs/agents', 'docs/architecture', 'docs/ci', 'docs/contributing', 'docs/development', 'docs/flows', 'docs/getting-started', 'docs/guides', 'docs/integrations', 'docs/maintenance', 'docs/observability', 'docs/operate', 'docs/operations', 'docs/phases', 'docs/product', 'docs/project', 'docs/quality', 'docs/reference', 'docs/samples', 'docs/spec', 'docs/strategy', 'docs/testing', 'docs/trace', 'docs/troubleshooting', 'docs/verify', 'docs/workflows'];
