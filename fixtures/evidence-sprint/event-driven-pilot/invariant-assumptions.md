...
| Report-only conformance | Rule failures from `pnpm run conformance:verify:sample` are evidence for review and escalation decisions, not automatic merge blockers in this pilot. |
